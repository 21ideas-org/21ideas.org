---
title: "Биткоин — волшебные интернет-деньги"
tags: ["биткоин", "деньги", "bitcoin", "proof-of-work"]
description: "Волшебное происхождение Биткоина."
url: bitcoin-volshebnye-internet-dengi
bookToc: true
bookFlatSection: false
weight: 6
---

![cover](/img/0001.jpg#center)
...
![name](/img/0004.png#center)

![name](/img/0005.jpg#center)
...
[4] ["Free Ross"](https://freeross.org/?ref=21ideas.org) – это петиция, которая была запущена в знак протеста против этого чрезмерно жесткого приговора и борьбы за помилование Росса Ульбрихта.
...
[7] Например, мой друг [Раджарши Майтра](https://www.citadel21.com/from-hello-world-to-bitcoin-core?ref=21ideas.org).
