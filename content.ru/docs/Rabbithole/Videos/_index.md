...
url: videos
# cover: /img/main-section/ru/videos-light.webp
# coverDark: /img/main-section/ru/videos.webp
...
[Текстовая версия гида](/electrum)
{{< /details >}}
...
[Текстовая версия гида](/hodl-hodl)
{{< /details >}}
...
[Текстовый гид по BlueWallet](/blue)
{{< /details >}}
...
⚠️ **Уязвимость COLDCARD, июль 2026.** В прошивках устройства найден дефект генератора случайных чисел, затронуты все модели, кроме Mk1. Видео записано до инцидента и показанную в нём процедуру создания сида повторять нельзя — сперва прочитайте [предупреждение в гиде](/coldcard) и разбор в статье «[Сид на костях](/dice-seed)».
{{< /details >}}
