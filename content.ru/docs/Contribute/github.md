...
14. Когда статья (и изображения) готова и проверена, необходимо проверить не были ли внесены изменения в основной репозиторий пока вы добавляли статью. Для этого необходимо перейти в "Pull requests" и обратить внимание на строку, расположенную сразу над основной папкой с файлами репозитория:



15. Жмем "New pull request" (может понадобиться подтвердить свои намерения несколько раз, здесь все интуитивно).
...
Вы добавили статью из своего локального репозитория в свой форк основного репозитория 21ideas. Далее необходимо сделать пулл-реквест, чтобы эти же предложения попали в основной репозиторий. 
