...
{{< hint btc >}}
Названия файла указываем транслитом. Для получения транслита можно использовать [этот](https://www.itranslit.com) сайт. Далее пробелы в названии необходимо заменить на дефисы (`-`). 
{{< /hint >}}
