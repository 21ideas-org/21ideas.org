...
* [Ознакомиться с синтаксисом Markdown](/md/)
...
* `28` - указывает порядковый номер изображения в библиотеке. Каждое изображение, присутствующее на сайте хранится в корневой папке `static/img/`. 
