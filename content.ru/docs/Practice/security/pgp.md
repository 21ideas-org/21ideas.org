...
Описание установки GPG в [Linux](/pgp-verify/#linux) и [MacOS](http://localhost:1313/pgp-verify/#macos) находится выше в данной статье. Если вы уже использовали GpgFrontend, то ничего устанавливать не нужно.
