...
Живя в цифровую эпоху важно уделять внимание приватности. Информация всегда стремится на волю, и необходимо делиться с окружающими как можно меньшим количеством персональных данных. Это особенно критично, когда речь заходит о финансах - никто не хочет, чтобы размеры их сбережений стали общедоступной информацией. К сожалению, большинство продолжает пользоваться централизованными биржами и проходить процедуру  KYC, связывая все свои последующие покупки с собственной личностью. Биржи часто подвергаются взломам, при которых не только крадут биткоины, но и копируют персональные данные пользователей с целью дальнейшей продажи баз данных в даркнете. Цель сегодняшней статьи - детально описать один из наиболее приватных методов покупки и продажи биткоина, где вам не нужно предоставлять даже адрес электронной почты. Встречайте: RoboSats.
...
**Акцент на приватности пользователей:** RoboSats использует браузер Tor. Площадка также не требует от вас каких-либо данных, даже email. Вместо этого при входе вы можете либо сгенерировать новый аккаунт, либо использовать ранее сгенерированный.
...
_Не забудьте сохранить полученный токен в приложение заметок на ваш выбор. Это делается лишь на время данной сессии на случай, если ваше соединение прервется._
{{% /image %}}
...
{{< hint warning >}}
Обратите внимание, что далее мы будем описывать процесс принятия ордера на продажу, то есть мы будем покупать биткоин у продавца, уже разместившего оффер на площадке. Далее в тексте мы опишем процесс создания оффера на продажу биткоина и непосредственную продажу монет. Таким образом у вас будет полная картина того, как происходит обмен со всех сторон. 
{{< /hint >}}
...
С версией 0.6.0-alpha RoboSats [представили](https://learn.robosats.com/robosats/update/pre-release-robosats-decentralized/) федерации - возможность каждому желающему запустить собственную версию площадки и координировать торги. Это - огромный шаг в сторону децентрализации платформы и ее цензуроустойчивости. Тем не менее, мы еще находимся на ранних стадиях, и поделиться гидом о запуске федерации мы пока не можем. Следите за обновлениями и появлением стабильной публичной версии.
