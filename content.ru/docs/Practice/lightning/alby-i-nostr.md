...
{{< hint info >}}
Гид написан в 2023 году. Alby с тех пор перевёл кастодиальный аккаунт на платную основу — раздел о регистрации через сам сервис неактуален. Подключение собственного кошелька или узла работает как описано. Для подробных инструкций обратитесь к официальному источнику [https://guides.getalby.com/user-guide](https://guides.getalby.com/user-guide)
{{< /hint >}}
