...
*UPD: эта проблема решена с добавлением сплайсинг-функционала в [последней](https://acinq.co/blog/phoenix-splicing-update) версии Phoenix. Теперь у каждого пользователя только 1 канал, который меняется в объёме в зависимости от входящей ликвидности*
