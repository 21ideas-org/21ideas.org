---
title: "Кошелек Blue"
h1: "BlueWallet: мультисиг, холодные хранилища, поддержка кошельков watch-only и многое другое"
cover: /img/111.webp
...
Как хранить свои биткоины на мобильном устройстве? Безопасное горячее и холодное хранение биткоина.
...
Кошелек Blue позволяет вам импортировать Лайтнинг-кошельки для удобного взаимодействия с вашими сатошиками в самой быстрой и доступной сети для передачи биткоина. Вы можете импортировать как кастодиальные решения, например, Alby, так и некастодиальные кошельки, запущенные на собственном узле благодаря таким программным решениям как Umbrel, MyNode и Start9.

{{% image "/img/115.webp" /%}}

_Возможности:_

*   импорт кастодиального кошелька-браузерного расширения Alby (или любого другого) позволяет вам управлять вашими средствами с мобильного телефона создавать инвойсы, отправлять и получать средства;
*   подключение собственного лайтнинг узла дает вам все преимущества самостоятельного управления своими лайтнинг-сатошиками, позволяя при этом оставаться мобильным
...
*   Лайтнинг-браузер: прямой доступ к вашим любимым приложениям, поддерживающим Lightning, из BlueWallet-браузера.
...
Упомянув поддержку аппаратных кошельков, отметим и кошелек Coldcard, о котором у нас есть [отдельный гид](/coldcard).

{{< hint danger >}}
**⚠️ Уязвимость COLDCARD, июль 2026.** В прошивках COLDCARD найден дефект генератора случайных чисел: с 2021 года устройство молча использовало программный запасной генератор вместо аппаратного. Затронуты все модели, кроме Mk1. Прежде чем создавать на нём ключ, прочитайте [предупреждение в гиде](/coldcard) и разбор инцидента в статье «[Сид на костях](/dice-seed)».
{{< /hint >}}
...
Мультисиг [[1](/multisig-1)] [[2](/multisig-2)] – самая безопасная схема хранения биткоинов. Мультисиг напоминает хранилище, где для расходования монет требуется несколько ключей. Рекомендуется для холодного хранения и хранения больших сумм.
...
Помимо всего вышеупомянутого BlueWallet также позволяет интегрировать множество сторонних приложений в свой UI. Вы можете объединить его с [ZapGram](https://t.me/zap_gram_bot), подключить кошелек к собственной ноде, воспользоваться опцией Local Trader, предоставленной одноранговой площадкой для купли-продажи биткоинов HODL HODL. Подробнее о площадке и способах покупки биткоинов в обход процедуры KYC можно узнать из нашего видеогида: 

{{< youtube aZQ-9rZG0-w >}} 
_Также доступна [текстовая версия](/hodl-hodl)_
{{< /youtube >}}
...
… и порекомендуем скачать BlueWallet [с официального сайта](https://bluewallet.io/), чтобы воспользоваться его функциями:
