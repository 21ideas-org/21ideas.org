...
h1: "Не твои ключи — не твои биткоины — настройка кошелька Electrum"
cover: /img/53.png
...
Как хранить свои биткоины в начале пути? Безопасное горячее хранение биткоина.
...
Нам предложен выбор типа кошелька, который мы хотим создать. Мы можем создать стандартный кошелек, кошелек с двухфакторной аутентификацией, кошелек мультисиг (статьи [[1](/multisig-1)] [[2](/multisig-2)] + [видео](https://www.youtube.com/watch?v=K2nyxlEkGts&t=491s)), а также у нас есть опция импортировать адреса или приватные ключи.
