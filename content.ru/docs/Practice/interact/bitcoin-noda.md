...
# Каждому следует запустить собственную Биткоин-ноду! Вот почему:
...
![core-controls](/img/194.jpeg)
|:--:|
[Кто контролирует Bitcoin Core?](/kto-kontroliruet-bitkoin-kor)
