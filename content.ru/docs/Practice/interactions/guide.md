...
# Используем биткоин (гид для новичков)

{{< hint btc >}}
Гид подготовлен [Тони⚡️](https://snort.social/p/npub10awzknjg5r5lajnr53438ndcyjylgqsrnrtq5grs495v42qc6awsj45ys7) на базе [работы](https://www.upfolio.com/bitcoin-quick-start-guide), проделанной командой upfolio.
{{< /hint >}}

Узнайте как покупать, хранить и пользоваться биткоином
...
2.   у этих площадок есть ряд преимуществ (подробно описанных в [этой статье](https://new.21ideas.org/docs/Theory/privacy/no-kyc/).
...
Обязательным шагом после приобретения биткоинов на бирже является вывод средств на подконтрольные вам адреса (кошельки). Подробнее о том, зачем и как самостоятельно хранить свои биткоины, можно узнать из [этой статьи](https://new.21ideas.org/docs/Theory/security/storing-keys/).
...
* [Blue Wallet](https://bluewallet.io/) (поддержка Lightning, гид доступен по [этой ссылке](https://new.21ideas.org/docs/Practice/lightning/blue/))
...
* [Coldcard](https://store.coinkite.com/promo/970E08C1C7383C967C7B) (гид по кошельку Coldcard доступен по [этой ссылке](https://www.21ideas.org/practice-what-is-coldcard/))
* [SeedSigner](https://seedsigner.com). SeedSigner является отличным устройстом для безопасного оффлайн-хранения ваших биткоинов. Гид по нему доступен [здесь](https://new.21ideas.org/docs/Practice/hodl/seedsigner/)
...
{{< hint btc >}}
Информация оказалась полезной? Все предоставляемые материалы распространяются безвозмездно, готовятся и курируются сообществом, и проект нуждается в вашей поддержке. Вы можете поддержать проект финансово, либо внести вклад в его развитие через добавление полезных материалов о Биткоине. Подробнее о возможности участия в улучшении самой обширной русскоязычной биткоин-библиотеки и развитии русскоязычного сообщества биткоинеров можно узнать [здесь]({{< ref "/Contribute" >}}).
{{< /hint >}}