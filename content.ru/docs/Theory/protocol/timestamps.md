...
cover: /img/timestamps/timestamps-cover.webp
...
{{% image src="/img/timestamps/timestamp.webp" %}}
...
{{% image src="/img/timestamps/2016bloks-time.webp" %}}
...
{{< image src="/img/timestamps/median.webp" />}}
...
{{< image src="/img/timestamps/timeframes.webp" />}}
...
[^1]: [Proof of Work: доказательство проделанной работы](/proof-of-work/)
