...
Халвинг – регулярное событие, которое случается каждые 210,000 блоков (примерно каждые четыре года). Учитывая, что новый блок появляется в среднем каждые 10 минут, мы получаем частоту халвингов, незначительно превышающую четырехлетние интервалы. Изначально размер вознаграждения за найденный блок составлял 50 монет; сегодня, спустя 15 лет и 3 халвинга, вознаграждение равно 6.25 монет и снизится до 3.125 биткоинов в апреле. Цель халвингов – обеспечить постепенное снижение скорости выпуска новых монет. Уполовинивание награды будет продолжаться до тех пор, пока примерно в 2140 году не будет выпущен (почти) 21 миллион биткоинов. К тому моменту стимулировать майнеров к обеспечению безопасности сети будут комиссии за транзакции.
