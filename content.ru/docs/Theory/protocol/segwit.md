...
{{% image "/img/segwit/16-ru.webp" %}}
_Порог 95% рассчитывается в течение периода между корректировками сложности ([целевого значения](/difficulty/)). Если 95-процентный порог достигнут, софтфорк активируется в начале _следующего_ периода (который составляет 2016 блоков, или примерно 2 недели)._
{{% /image %}}
