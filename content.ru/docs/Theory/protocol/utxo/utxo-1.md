...
{{< image src="/img/utxo/custody.webp" />}}
...
{{< image src="/img/utxo/2-in-1-out.webp" />}}
...
{{< image src="/img/utxo/1-in-2-out.webp" />}}
...
{{< hint btc >}}
Если вы хотите более подробно изучить концепцию причастности UTXO, мы ведем работу по переводу статьи, посвященной этой теме. Поддержать работу над переводом можно [здесь](https://web.archive.org/web/20240404055030/https://web.archive.org/web/20211202183933/https://legend.lnbits.com/tipjar/1167).
{{< /hint >}}
...
{{< image src="/img/utxo/consolidate.webp" />}}
...
Этот материал – вступление в более комплексной и объемной теме управления своими монетами. Мы продолжаем работу над переводом этой серии статей, поддержать которую можно [здесь](https://web.archive.org/web/20240404055030/https://web.archive.org/web/20211202183933/https://legend.lnbits.com/tipjar/1167).
