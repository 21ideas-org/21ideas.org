...
{{% image src="/img/gts-4-1.webp" alt="Хэшрейт Биткоина" /%}}
...
{{< hint info >}}
Книга “Биткоин-стандарт”, названная в переводе “Краткая история денег”, [доступна в формате epub](https://media.21ideas.org/epubs/the-bitcoin-standard-ru.epub).
{{< /hint >}}
...
{{% image src="/img/gts-4-2.webp" alt="Отрывок из книги “Дорога к рабству”" %}}
...
{{< hint info >}}
Книга “Дорога к рабству” [доступна в формате PDF](https://media.21ideas.org/epubs/road-to-serfdom-ru.pdf).
{{< /hint >}}
...
{{% image src="/img/gts-4-3.webp" alt="Месячные показатели производства нефти Венесуэллой" /%}}
...
{{% image src="/img/gts-4-4.webp" alt="Скорректированная денежная база США" /%}}
