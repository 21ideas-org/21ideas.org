...
Идея "антихрупкости", популяризированная Нассимом Талебом, характеризует системы или явления, которые черпают свою силу из неупорядоченности, чем как раз и является Биткоин "до мозга костей". Не существует универсального средства, способного убить Биткоин; нет конкурента, который может мистическим необъяснимым образом его обогнать; так же, как и нет правительства, которое могло бы его уничтожить. Но это ещё не всё – каждая враждебная атака и каждое потрясение для его системы фактически приводят к тому, что Биткоин становится только сильнее.
...
По мере того, как Биткоин переживает потрясения, а люди учатся на ошибках и приспосабливаются к его волатильности, Биткоин становится ощутимо более надёжным; демонстрируемые им устойчивость и иммунитет вызывают укрепление доверия к сети, вследствие чего растёт его принятие, и Биткоин становится более резистентным и к будущим атакам, и к индивидуальным ошибкам пользователей.
Это является ничем иным как позитивным, самоподдерживающимся циклом обратной связи.

С каждой неудавшейся попыткой кооптирования или принуждения сети, протокол Биткоина укрепляется, а уверенность в нём ещё сильнее возрастает. Всякий раз, когда Биткоин переживает какое-либо потрясение, само это событие придаёт Биткоину импульс для движения вперёд, делая его значительно более сильным, чем он был до этого.

{{% image "/img/gts-15-2.png" /%}}

Любое потрясение в сети в результате воздействия внешних факторов является практическим опытом, который заставляет Биткоин спонтанно адаптироваться, что само по себе является неотъемлемым признаком децентрализованной системы. Поскольку Биткоин – это децентрализованная система, децентрализация которой растёт в зависимости с течением времени (и ростом принятия), она лишена единой точки отказа. Более того, увеличивающаяся степень устойчивости сети гарантирует её выживаемость и укрепляет её против будущих атак.

Существует положительная корреляция между временем и степенью децентрализации сети. Точно так же существует положительная корреляция между степенью децентрализации и способностью сети противостоять более серьёзным атакам.
...
Многие из крупнейших компаний, которые предоставляют услуги по хранению и обмену биткоинов, пришли к соглашению с крупными биктоин-майнерами, которые контролировали более 85% майнинговых мощностей сети (или скорости хеширования) в попытке добиться изменения правил консенсуса. Эта группа влиятельных брокеров планировала удвоить размер блока Биткоина, как средство увеличения пропускной способности сети. Однако увеличение размера блока потребовало бы изменения правил сетевого консенсуса, что привело бы к разделению (или хардфорку) сети.
В рамках достигнутого в ходе переговоров соглашения группа предложила запустить значительное обновление сети под названием SegWit[^3], которое не меняло бы правила консенсуса. Вместе с обновлением SegWit предлагалось удвоить размер блока, что изменило бы правила консенсуса. С учётом того, что в этих переговорах принимали участие почти все крупные поставщики услуг и майнеры, был дан ход осуществлению планов по внедрению этих изменений. Однако, неприятным сюрпризом для “большеблочников” стал тот факт, что операторы узлов сами запустили обновление сети SegWit без изменения сетевого консенсуса и без увеличения размера блока[^4]. Попытка изменить правила консенсуса сети с треском провалилась, и неискажённый Биткоин спокойно продолжил своё неуклонное шествие вперёд.

На практике зачастую невозможно заранее сказать, обладает ли Биткоин устойчивостью к той или иной угрозе, пока таковые не возникнут. В данном случае именно беспорядок помешал скоординированным силам повлиять на сеть, и в то же время все узнали, насколько Биткоин устойчив к цензуре, что, в свою очередь, ещё больше укрепило сеть.

Тед Роджерс, президент XAPO, до провала Segwit2x: 

> "Я хотел бы внести ясность – мы глубоко озабочены противодействием цензуре. Но скажите мне, что больше всего волнует среднестатистического нового пользователя – цензура или комиссия за транзакцию и скорость? Я полагаю, что второе".

Тед Роджерс после провала Segwit2x: 

> "По иронии судьбы именно проигрыш в дискуссии о Segwit2x заставил меня осознать всё это раз и навсегда – большая и мощная индустрия бросила все на реализацию, казалось бы, безобидного изменения в BTC, чтобы минимизировать последствия предполагаемого кризиса. Наши попытки с треском провалились. Провал Segwit2x стал окончательной победой Биткоина как цифрового золота. BTC неконтролируемый, неуправляемый и полностью децентрализованный. Неизменный. Гибкость и управление могли бы, конечно, помочь в создании валюты, но это помеха для средства сбережения и инструмента неизменного учёта транзакций".
...
– Хардфорк в сети Bitcoin Cash;
- Биткоин доказал свою устойчивость к цензуре
- Биткоин побеждает и укрепляется


Государственное регулирование
– Запрет Резервным банком Индии оказания банковского обслуживания криптовалютным компаниям;
– Китай принимает жёсткие меры в отношении деятельности обменных бирж и майнинговых компаний;
– Представители Конгресса США требуют запретных и ограничительных мер;
– Власти США включили некоторые биткоин-адреса в санкционный список Управления по контролю за иностранными активами Минфина США (OFAC);
- Сеть продолжает бесперебойно функционировать
- Сеть адаптируется и защищается от угроз
- Биткоин побеждает и укрепляется

Протоколы-конкуренты
– Хардфорки и копии Биткоина;
– "Всемирный Компьютер";
– Утилитарные токены;
– Стэйблкойны;
– Libra от Facebook;
- Конкурирующие валюты терпят неудачу
- Биткоин остается доминирующей валютой
- Рыночные тесты предоставляют информацию
- Биткоин побеждает и укрепляется

Ошибки компаний или поставщиков услуг
– Взлом Mt.Gox – похищены биткоины;
– Взлом Bitfinex – похищены биткоины;
– Взлом Binance – похищены биткоины;
– Взлом BlockFi – похищены личные данные пользователей;
– Уязвимости аппаратных криптовалютных кошельков;
- Ответственные стороны несут издержки за совершённые ошибки 
- Никаких экстренных спасений
- Подотчетность устраняет моральный риск
- Компании адаптируются или терпят крах
- Биткоин побеждает и укрепляется

Ошибки отдельных пользователей
– Личные аккаунты на обменных биржах подвергаются взлому;
– Личные счета подвергаются заморозке или закрытию;
– SIM-свопинг;
– Кража или утеря биткоин-кошельков;
– Утеря кодовой фразы к приватным ключам;
– Вредоносные расширения для интернет-браузеров и вредоносное ПО;
- Ответственные стороны несут издержки за совершённые ошибки 
- Никаких экстренных спасений
- Подотчетность устраняет моральный риск
- Отдельные лица приспосабливаются или теряют деньги
- Биткоин выигрывает, укрепляется
...
Биткоин-майнинг в Соединённых Штатах (как и во многих других странах) продолжает расти, и Питер Тиль недавно поддержал стартап, который запускает майнинговые операции в Западном Техасе.
...
Совершенно иной тип стресса исходит от конкурирующих с Биткоином криптовалют.
С момента запуска Биткоина в 2009 году было запущено не менее тысячи цифровых валют-конкурентов. Хотя зачастую (но не всегда) они и заявляют о разных с Биткоином целях и "сценариях использования", на самом деле во всех случаях каждая из них конкурирует с ним за право быть деньгами. Во многих случаях создатели действительно указывают на очевидные изъяны Биткоина и на то, как конкретный конкурирующий протокол намеревается избавиться от его "ограничений".
...
Конкуренция по своей сути благоприятна для Биткоина. Мало того, что каждая попытка создать улучшенную версию Биткоина терпит неудачу, повторяющиеся неудачи фактически информируют участников рынка о том, что есть что-то, что отличает Биткоин от остальных криптовалют. Даже если ответ на вопрос "что" или "почему" не бросается сразу в глаза, рынок предоставляет эту полезную информацию.
Биткоин не просто "держит удар" конкурентов – он их побеждает.

Тот факт, что 
, легче доказать с помощью рыночных функций и рыночных тестов, чем с помощью любых аргументов и логики. Благодаря неудачному опыту конкурирующих валют Биткоин накапливает больше человеческого капитала, и, как прямое следствие этого, его сеть растёт.
...
Каждый пользователь несёт полную и независимую личную ответственность за безопасность своих сбережений в биткоинах, не важно, доверяет он их хранение третьей стороне или берёт эту задачу на себя. Многие из крупнейших мировых криптовалютных бирж подвергались взломам наряду с рядовыми пользователями, пользующимися сетью. Тем же, кого это бедствие миновало, не стоит расслабляться, ведь от взлома никто не застрахован.

Несмотря на то, что пользователи сети нередко оказываются уязвимы, их взламывают или не лишают доступа к их биткоинам иным способом, это не оказывает никакого влияние на функционирование сети. Однако, как и все прочие факторы стресса, такие возможные угрозы напрямую заставляют сеть адаптироваться и становиться сильнее.


Из-за многочисленных критических сбоев на криптовалютных биржах участники рынка всё чаще приходят к тому, чтобы брать на себя ответственность за хранение собственных биткоинов, не полагаясь на сторонних поставщиков кастодиальных услуг. Такая же тенденция наблюдается и вследствие взломов персональных аккаунтов на криптовалютных биржах. Аналогичным образом, по мере выявления угроз для тех, кто предпочитает лично заботится о безопасности своих биткоинов, разрабатываются более надёжные кошельки, а сами пользователи выбирают более безопасные способы надёжной защиты своих биткоинов, [путём уменьшения или устранения единых точек отказа](/multisig/). Это непрекращающаяся эволюция, рождённая на основании того факта, полученного из практического опыта, что стрессоры существуют повсюду.

Сеть не подвержена каким-либо критическим сбоям, потому что вся сеть круглосуточно итерируется посредством проб и ошибок, а свободная конкуренция и бесконечные рыночные возможности стимулируют появление и развитие инноваций. В случае проблем же, каждый становится сам по себе и каждый сам отвечает за свои действия. Система стимулирования требует, чтобы все постоянно искали лучшие способы обеспечения безопасности Биткоина. Благодаря такому давлению, вызванному стрессом, сеть укрепляется весьма естественным и органичным образом.


Подобно той пользе, которую приносят постоянные факторы стресса, волатильность также существенно укрепляет иммунитет системы. И хотя её часто называют критическим недостатком Биткоина, [волатильность на самом деле является особенностью, а не ошибкой](
). Волатильность – это выявление цены в ходе свободного рыночного торга, и для биткоина она непрекращающаяся и непрерывная. На этом рынке не существует никаких операций ФРС по спасению инвесторов, как нет и процедуры временного прекращения торгов.
Каждый несёт личную ответственность за то, как он справляется с волатильностью, если кто-то окажется "за бортом", то никто не придёт и не бросит спасательный круг.
Поскольку никаких спасательных мер нет, исключается моральный риск по всей сети.
...
В Биткоине нет системно значимых (слишком больших, чтобы обанкротиться) субъектов. В конечном счёте, цена передаёт информацию, и все участники рынка независимо друг от друга наблюдают за рыночными силами. Каждый из них либо приспосабливается, либо сам расплачивается за свои ошибки.



> "… Со свободой приходит немного непредсказуемой нестабильности. Это одна из особенностей жизни: без шума нет свободы, и нет стабильности без волатильности",
> 
>/– Нассим Талеб, Чёрный лебедь Каира

Но рыночная информация передаётся не только посредством волатильности цены.
Волатильность – это также то, как распределяется биткоин, и то, как сеть становится ещё более децентрализованной. Каждый раз, когда где-то продаётся биткоин, его кто-то покупает. Постепенно с течением времени владение сетью становится более децентрализованным, и это особенно остро проявляется в периоды нестабильности.
Волатильность весьма ощутимо укрепляет Биткоин за счёт децентрализации. Таким образом, Биткоину не грозит участь [тюльпанов](
); он не лопнет, как это произошло с пузырём тюльпанов.

По мере того, как сеть становится более децентрализованной, она также становится более устойчивой к цензуре, и каждый пользователь сети владеет все меньшей и меньшей долей общего предложения (в среднем), что вызывает динамику, при которой со временем цена всё меньше зависит от предпочтений нескольких крупных держателей биткоинов.

Нельзя сказать, что не осталось биткоин-китов, которые могут однозначно влиять на цену и волатильность, но в качестве направленного тренда влияние любого человека на цену со временем уменьшается и часто непосредственно через распределительную функцию самой волатильности.
И когда участники сети, по отдельности и в целом, видят, что Биткоин выживает даже после существенных резких падений, сам факт этого укрепляет их доверие к сети.
На определённых ценовых уровнях люди даже готовы устремиться на рынок, чтобы "
".
...
В 2011 году Росс Ульбрихт запустил веб-сайт Silk Road, который использовал биткоины для упрощения онлайн-платежей за наркотики. Сайт стал платформой для одного из первых способов применения Биткоина в торговле, несомненно, сыграв существенную роль в продвижении раннего принятия и осведомлённости. 

В 2014 году была взломана биржа Mt.Gox, и это событие, возможно, оказало самое большое влияние на продвижение и распространение аппаратных биткоин-кошельков, поскольку частные лица и компании стремились избежать рисков бирж и разработали способы более безопасного хранения биткоинов, не полагаясь на услуги третьих лиц.

В 2017 году, после того как один поставщик услуг, связанных с биткоином, так разозлил Николаса Дорье, что тот решил создать собственный продукт, призванный сделать этого поставщика и его услуги морально устаревшими. Это положило начало одному из самых захватывающих проектов с открытым исходным кодом в Биткоине, 
.
...
[^1]: Кто контролирует Bitcoin Core – 
 

[^2]: Управление Биткоином – 
 

[^4]: Что такое SegWit? – 


[^3]: Джонатан Бир, “Война за размер блока” – 
