...
- Если сеть лайтнинг недоступна, используйте кошелек, который должным образом реализует [_CoinJoin_](/privacy/coinjoin).
