---
title: "Часть 3: Защита от цепного анализа"
h1: "Часть 3: Защита от цепного анализа"
...
После того как в [части 1](/privacy/oxt-1) и [части 2](/privacy/oxt-2) были представлены основополагающие понятия цепного анализа, в части 3 будут рассмотрены методы преодоления цепного анализа.
...
В третьей части мы представили множество инструментов, позволяющих преодолеть основные эвристики цепного анализа.
