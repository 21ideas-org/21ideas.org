...
{{% image "/img/oxt/oxt-30.webp" %}}
_Неоднозначная простая трата ([TxID](https://web.archive.org/web/20211130072726/https://web.archive.org/web/20170202120225/https://oxt.me/transaction/e610d6ab26878c9f37502b3f31755ae5066d9e982613c6042757d8972d412a84))_
{{% /image %}}
...
{{% image "/img/oxt/oxt-31.webp" %}}
_Визуализация движения UTXO с помощью графа транзакций OXT ([TxID](https://web.archive.org/web/20211130072726/https://web.archive.org/web/20170202120225/https://oxt.me/transaction/e610d6ab26878c9f37502b3f31755ae5066d9e982613c6042757d8972d412a84))_
{{% /image %}}
...
_[Пример](https://web.archive.org/web/20211127054850/https://web.archive.org/web/20170202120225/https://oxt.me/transaction/c7d1e40ae001a7fe4c860f9b7ddddcf9b5a3dad461466744e9b5e28c4b47e6b7) серии транзакций с несколькими входами и выходами_
{{% /image %}}
...
Сегодня концепция CoinJoin Sudoku была расширена [алгоритмом Больцмана](https://web.archive.org/web/20201111003822/https://code.samourai.io/oxt/boltzmann), созданным [LaurentMT](https://twitter.com/laurentmt), ведущим разработчиком OXT. Алгоритм Больцмана использует концепцию CoinJoin Sudoku для оценки транзакций по нескольким параметрам, связанным с приватностью.
...
{{% image "/img/oxt/oxt-34.webp" %}}
_Подмножество матриц связей в OXT ([TxID](https://web.archive.org/web/20211124061702/https://web.archive.org/web/20170202120225/https://oxt.me/transaction/3a7455d3f04709870f7148f9f9c8d6c8a3fd83e8c76afadf6a4acd613afdb53e))_
{{% /image %}}
...
Благодаря участию нескольких пользователей эти транзакции также нарушают CIOH (эвристику общих входов, о которой мы говорили в [предыдущей части](/privacy/oxt-2/#кластеризация-кошельков--эвристика-владения-совместными-входами)). Если предположить, что входы в транзакцию, которые участвуют в CoinJoin, контролируются одним кошельком, это может привести к ложному срабатыванию CIOH как на кластер кошелька.
