...
Многоразовые платежные коды лишают аналитиков "простой" стартовой точки в блокчейне Биткоина. Более подробную информацию о многоразовом платежном коде в Samourai Wallet можно найти [здесь](https://web.archive.org/web/20230926232515/https://docs.samourai.io/wallet/paynyms).
...
{{% image "/img/oxt/oxt-45.webp" %}}
_[Пример](https://web.archive.org/web/20220701222918/https://web.archive.org/web/20170202120225/https://oxt.me/transaction/ee0d4dd6703949e594d88734ec40aa669a586c3126ee713bcf5883bd7f55b816) Ricochet-транзакции_
{{% /image %}}

Текущая версия Ricochet производит четыре дополнительных скачка. Более "динамичный" Ricochet с изменяемым количеством хопов планируется в будущих обновлениях. Более подробную информацию о Ricochet можно найти [здесь](https://web.archive.org/web/20210608000813/https://docs.samourai.io/wallet/privacy-enhanced-transactions#ricochet).
...
{{% image "/img/oxt/oxt-47.webp" %}}
_[Пример](https://web.archive.org/web/20220701224025/https://web.archive.org/web/20170202120225/https://oxt.me/transaction/14ff5e5c9206f7722b0ed421d26f1cb003c523070c4882150073817683bd2dda) Stowaway-транзакции_
{{% /image %}}
