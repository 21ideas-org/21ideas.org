---
title: "Часть 4: Применение концепций цепного анализа для улучшения приватности пользователей"
h1: "Часть 4: Применение концепций цепного анализа для улучшения приватности пользователей"
...
Ранее в этом руководстве были представлены основные концепции, используемые в цепном анализе, и концепции, используемые для преодоления цепного анализа.

Вряд ли пользователи, читающие это руководство, стремятся стать "экспертами" в области цепного анализа, но фундаментальное понимание инструментов и концепций, используемых для атаки на их приватность, позволит им лучше защищать свою конфиденциальность.
...
Большая часть цепного анализа основана на следующих основных концепциях:
...
В [первой](/privacy/oxt-1) и [второй](/privacy/oxt-2) частях мы представили основные концепции цепного анализа. В [части 3](/privacy/oxt-3) были представлены концепции, используемые для преодоления этих методов.
...
На уровне протокола Биткоин-транзакции отправляют биткоины на прозрачные адреса и с прозрачных адресов на прозрачные суммы. Такая прозрачность привела к распространению анализа блокчейна. В основном цепной анализ включает в себя обнаружение сдачи в платежах, анализ графа транзакций и использование эвристики владения совместными входами для "кластеризации кошельков".
...
Скорее всего, типичный пользователь, читающий это руководство, не стремится стать экспертом в области цепного анализа. Скорее, он стремится повысить уровень приватности при отправке и получении платежей. При отправке и получении платежей получателю платежа обязательно передается информация о кошельке отправителя из набора UTXO. В результате отправители и получатели платежей получают возможность оценить соответствующие прошлые и будущие траты этих известных UTXO, что может раскрыть дополнительную информацию о контрагенте.

Пользователи, обладающие знаниями о цепном анализе, лучше подготовлены к оценке последствий расходования и получения средств и могут начать предпринимать шаги по защите своей приватности.

К таким шагам относятся: отказ от привязки действий в блокчейне к личности в интернете, избегание повторного использования адресов, разделение UTXO с разной историей, обеспечение приватности в будущем с помощью CoinJoin, а также использование расширенных инструментов траты, рассмотренных ранее, для преодоления эвристик цепного анализа.
