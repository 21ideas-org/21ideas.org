...
Перевод [статьи](https://bitcoinmagazine.com/culture/why-bitcoin-not-s-coin) Алекса Светски 
...
[Абсолютно все, разделенное на 21 миллион.](https://youtu.be/apWeaKADnlY)
...
|:--:|
| Чем длиннее график, тем хуже он выглядит для доллара США | 


| ![image4](pictures/04.png)|
|:--:|
| Это логарифмическая диаграмма, поэтому падение выглядит не таким резким, но вы можете видеть, что доллар обесценился на порядок по отношению к биткоину | 
</center>
...
Как Биткоину это удается? Через затраты.
...
*Биткоин побеждает не по принуждению, а благодаря естественному отбору*
...
## Нет головы, которую можно срубить
...
*Моральное обоснование вытекает из философии биткоина.*
...
| ![image5](pictures/05.jpg)
|:--:|
| Источник: [Twitter](https://twitter.com/francispouliot_/status/1396275727843172355?s=21&) | 
</center>
...
Одна из самых блестящих [статей о том, как биткоин де-финансиализирует мир](https://www.21ideas.org/theory-economics-bitcoin-is-definancialization/), написана Паркером Льюисом. 

### От 0 до 1, а не от 1 до N

Биткоин – это трансформация денег и финансов, в которой мы заменяем_правителей_ проверяемыми, прозрачными _правилами_, которые каждый может добровольно принять. “Крипта” по своей природе – это просто зеркальное отображение традиционной финансовой системы, в которой один набор правителей заменяется другим. Вместо Джерома Пауэлла и Кристин Лагард мы получим Виталика Бутерина и Чарльза Хоскиссона. На смену одной группе больных манией величия бюрократов приходит другая. Это не является ни интересным, ни желательным.
...
*Биткоин в вас не нуждается. Это он нужен вам*
