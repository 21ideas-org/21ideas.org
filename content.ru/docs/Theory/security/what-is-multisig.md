...
{{% image "/img/multisig/examples.webp" %}}
...
{{% image "/img/multisig/m-of-n.webp" %}}
...
{{% image "/img/multisig/setups.webp" %}}
...
{{% image "/img/multisig/approaches.webp" %}}
