...
Расположенный на задней панели устройства датчик может быть активирован для разблокировки и подписания транзакций. Однако решение использовать датчик отпечатков пальцев может оказаться рискованным. Авторизация такого рода уязвима перед "атаками гаечным ключом" и лишает возможности правдоподобного отрицания.
...
Для работы в режиме с воздушным зазором в *Keystone Pro* предусмотрена возможность использования батарейки типа ААА или перезаряжаемого литий-ионного аккумулятора (оба варианта входят в комплект поставки). Как и в случае с *Coldcard Mk4*, использование внешних источников питания устраняет угрозу несанкционированной передачи данных по скомпрометированным зарядным кабелям.
...
{{< hint info >}}
\* Некоторые, [но не все компоненты](https://blog.keyst.one/on-open-source-and-transparency-ba37fa1c1e8c) устройства имеют открытый исходный код

† Прошивка, предназначенная только для биткоина, [не установлена по умолчанию](https://blog.keyst.one/the-relevance-benefits-of-keystones-btc-only-firmware-8965ebb42e48)
