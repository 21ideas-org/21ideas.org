...
{{< hint danger >}}
**⚠️ Уязвимость генератора случайных чисел, июль 2026.** В прошивках COLDCARD найден дефект: с 2021 года устройство молча использовало программный запасной генератор вместо аппаратного. Затронуты все модели, кроме Mk1, включая описанный ниже Mk4. Исправленные прошивки — 4.2.0 для Mk3, 5.6.0 для Mk4 и Mk5, 1.5.0Q для Q.

Броски кости защищают **только сид**: бумажные кошельки, перенос на другое устройство, Seed XOR в режиме random и встроенный генератор паролей сломаны независимо от них. Подробности — в [гиде по Coldcard](/coldcard), разбор инцидента — в статье «[Сид на костях](/dice-seed)».
{{< /hint >}}
...
{{< hint info >}}
Подробнее об особенностях Coldcard и его функциях можно узнать из нашего пошагового гида [здесь](/coldcard/)
{{< /hint >}}
...
{{< hint info >}}
Подробнее об этом способе подписания транзакций можно узнать из нашего [гида по SeedSigner](/seedsigner/), который также использует этот метод.
{{< /hint >}}
...
{{< hint info >}}
Подробную информацию о необходимых деталях, том как собрать свой собственный SeedSigner и о функциях этого уникального устройства можно получить в нашем гиде [здесь](/seedsigner/).
{{< /hint >}}
