...
Технически говоря, эти 24 слова являются представлением строки случайных цифр, называемых **сидом** _(от англ. seed - семя прим. пер.)_, из которого генерируются все ключи кошелька. Сид используется для генерации вашего **приватного мастер-ключа** _(master private key)_, лежащего в основе остальных ваших приватных ключей. **Приватные ключи** используются для создания соответствующих **публичных ключей**. Публичные же ключи могут использоваться индивидуально (по отдельности) или в сочетании с другими публичными ключами (мультисиг) для построения **биткоин-адресов**.
