...
{{< hint btc >}}
Перевод [статьи](https://unchained.com/blog/what-is-a-bitcoin-seed-phrase/) Стивена Холла подготовлен [Тони ⚡️](https://snort.social/p/npub10awzknjg5r5lajnr53438ndcyjylgqsrnrtq5grs495v42qc6awsj45ys7). 
...
{{% image "/img/seed/seed-address.webp" /%}}
...
{{< hint info >}}
Подробнее о лучших подходах к хранению сид-фраз читайте [в этой статье](/seed-security).
{{< /hint >}}
