...
cover: /img/blog/amir-cover.webp
...
Если бы я пришел на GitHub, я бы не принадлежал правильному политическому кругу, и меня бы отвергли. Очевидна [пропаганда](https://x.com/Narodism/status/1848301459483304326) против других узлов[^1], например, против клиента Эрика Воскуила. Эрик талантливый разработчик. Люди из Bitcoin Core заблокировали его финансирование с помощью пропаганды. Это коррупция. Когда в программном обеспечении Эрика были найдены ошибки, разработчики Core сразу выскочили с агрессивной критикой.
