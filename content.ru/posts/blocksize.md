...
cover: /img/blog/blocksize/block-size-cover.webp
...
Типичная транзакция, как правило, занимает не меньше 226 байт (см. [калькулятор размера транзакции](https://bitcoinops.org/en/tools/calc-size/)), что означает, что набор транзакций обычно занимает намного больше места в блоке, чем другие данные.
...
{{% image src="/img/blog/blocksize/size.webp" /%}}
...
{{% image src="/img/blog/blocksize/pre-post-segwit.webp" %}}
_Скользящий максимум размера блока до и после SegWit_
{{% /image %}}

{{% image src="/img/blog/blocksize/228538.webp" %}}
...
{{% image src="/img/blog/blocksize/quartile.webp" /%}}
...
{{% image src="/img/blog/blocks/cover.webp" %}}
...
{{% image src="/img/blog/blocksize/size2weight.webp" /%}}
...
{{% image src="/img/blog/blocksize/pre-segwit.webp" %}}
...
{{% image src="/img/blog/blocksize/weight-points.webp" %}}
...
{{% image src="/img/blog/blocksize/excess-blocks.webp" /%}}
...
{{% image src="/img/blog/blocksize/block-size-distribution.webp" %}}
...
{{% image src="/img/blog/blocksize/blocks.webp" %}}
...
{{% image src="/img/blog/blocksize/134334.webp" /%}}
...
{{% image src="/img/blog/blocksize/block-stats.webp" /%}}
...
{{% image src="/img/blog/blocksize/tx-backlog.webp" %}}
...
{{% image src="/img/blog/blocksize/percentage.webp" /%}}
...
{{% image src="/img/blog/blocksize/unfilled.webp" /%}}
...
{{% image src="/img/blog/blocksize/free-space.webp" /%}}

{{% image src="/img/blog/blocksize/weight-analysis.webp" /%}}

{{% image src="/img/blog/blocksize/cummulative-weight.webp" /%}}
...
{{% image src="/img/blog/blocksize/clear-mempool.webp" %}}
...
{{% image src="/img/blog/blocksize/projections.webp" /%}}
