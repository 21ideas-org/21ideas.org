...
The skeptic’s narrative consistently shifts over time. Stage one of grief: bitcoin could never work – [it is backed by nothing](/gradually-then-suddenly/bitcoin-is-not-backed-by-nothing). It is nothing more than a present-day tulip mania.  With each hype cycle, the value of bitcoin rises dramatically and is then followed by a correction. Often extolled as a crash by skeptics, bitcoin fails to die and in each instance, it finds support at levels higher than prior adoption waves. The tulip narrative becomes tired and the skeptics move on to more nuanced issues, re-anchoring the debate.  Stage two of grief follows: bitcoin is flawed as a currency. It is [too volatile](/gradually-then-suddenly/bitcoin-is-not-too-volatile) to be money, or it is [too slow](/gradually-then-suddenly/bitcoin-is-not-too-slow) to be a payments system, or it [cannot scale](gradually-then-suddenly/bitcoin-is-not-too-slow) to satisfy all the payments in the world, or it [wastes energy](/gradually-then-suddenly/bitcoin-does-not-waste-energy). The list goes on. This second step is a progression of denial and it is a significant departure from the idea that bitcoin is nothing more than nothingness.
...
> _“Money is one of the greatest instruments of freedom ever invented by man. It is money which in existing society opens an astounding range of choice to the poor man – a range greater than that which not many generations ago was open to the wealthy...”_
> 
